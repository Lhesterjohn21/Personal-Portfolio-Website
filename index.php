  ...
  <div class="site">
    ...
    <main class="hero" id="home">
      <section>
        ...
        <p class="description">
          Motivated by a passion for creating seamless digital experiences, I build modern, responsive web applications
          using
          technologies like React, React Native, Laravel, CodeIgniter, and WordPress.
        </p>
        <p class="description">
          As a motivated fresh graduate, I am seeking an entry-level web development role where I can apply my
          full-stack
          foundation, adapt to industry workflows, and deliver practical solutions to meaningful projects.
        </p>
        <div class="actions">
...
<span class="line"><span class="num">1</span><span><span class="syntax-comment">// Entry-Level Web Developer Profile</span></span></span>
<span class="line"><span class="num">2</span><span><span class="syntax-keyword">const</span> <span class="syntax-name">developer</span> = {</span></span>
<span class="line"><span class="num">3</span><span>  name: <span class="syntax-string">'JOHN LHESTER ARCO'</span>,</span></span>
<span class="line"><span class="num">4</span><span>  role: <span class="syntax-string">'Entry-Level Web Developer'</span>,</span></span>
<span class="line"><span class="num">5</span><span>  education: <span class="syntax-string">'BS IT Graduate'</span>,</span></span>
<span class="line"><span class="num">6</span><span>  skills: [<span class="syntax-string">'PHP'</span>, <span class="syntax-string">'Laravel'</span>, <span class="syntax-string">'JavaScript'</span>, <span class="syntax-string">'MySQL'</span>],</span></span>
<span class="line"><span class="num">7</span><span>  goal: <span class="syntax-string">'Build clean &amp; responsive web apps'</span>,</span></span>
<span class="line"><span class="num">8</span><span>  available_for_hire: <span class="syntax-boolean">true</span></span></span>
<span class="line"><span class="num">9</span><span>};</span></span>
        </pre>
      </aside>
    </main>
        ...
        <div class="projects-grid">
          ...
          <article class="project-card">
            ...
            <div class="project-content">
              ...
              <div class="project-links">
                <a class="project-link github-icon" href="#projects" aria-label="Open GitHub link"><svg
